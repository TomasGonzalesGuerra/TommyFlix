        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TmdbEpisodeId = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    MovieId = table.Column<int>(type: "int", nullable: true),
                    SerieId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WatchHistories_Series_SerieId",
                        column: x => x.SerieId,
                        principalTable: "Series",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_SerieId",
                table: "Favorites",
                columns: new[] { "UserId", "SerieId" },
                unique: true,
                filter: "[SerieId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchHistories_SerieId",
                table: "WatchHistories",
                column: "SerieId");
